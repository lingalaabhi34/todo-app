...
const verifyemail=({email,verifiedtoken})=>{
const transporter = nodemailer.createTransport({
    ...
    service:"gmail",
    auth:{
        user:"lingalaabhi34@gmail.com",
        pass:"jwxl esuz nzoc oxhv"
    }
    
});
const mailoptions={
    from:"lingalaabhi34@gmail.com",
    to:email,
    subject:"Email Verification for todoapp",
    html :`<head>
